...
function NftCards({ cards, usdExchangeRate, isCurrentUser, setRefreshPopupOpened, user, toggleLike, loggedIn, currentUser, setLoginPopupOpened, isExplictAccept, setExplictAccept }) {
        ...
        <>
            {cards && cards.length > 0 ?
                <div className="nft-cards">
                    <div className="nft-cards__filters">
                        <div className="nft-cards__category-and-price">
                            <div className="nft-cards__btn-box">
                                <div className="nft-cards__btn" onClick={() => {
                                    setCatPopupOpen(!catPopupOpen)
                                    setPricePopupOpen(false)
                                    setSortPopupOpen(false)
                                }}>
                                    <p className="nft-cards__btn-sort-by-text">Category</p>
                                    <svg className="nft-cards__btn-icon" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path className="nft-cards__btn-icon-stroke" d="M5.73605 1H3.03202C1.91201 1 1 1.92001 1 3.04882V5.77605C1 6.91206 1.91201 7.82407 3.03202 7.82407H5.73605C6.86406 7.82407 7.76807 6.91206 7.76807 5.77605V3.04882C7.76807 1.92001 6.86406 1 5.73605 1" stroke="white" />
                                        <path className="nft-cards__btn-icon-stroke" d="M5.73605 10.1758H3.03202C1.91201 10.1758 1 11.0886 1 12.2246V14.9518C1 16.0798 1.91201 16.9999 3.03202 16.9999H5.73605C6.86406 16.9999 7.76807 16.0798 7.76807 14.9518V12.2246C7.76807 11.0886 6.86406 10.1758 5.73605 10.1758" stroke="white" />
                                        <path className="nft-cards__btn-icon-stroke" d="M14.9685 1H12.2644C11.1364 1 10.2324 1.92001 10.2324 3.04882V5.77605C10.2324 6.91206 11.1364 7.82407 12.2644 7.82407H14.9685C16.0885 7.82407 17.0005 6.91206 17.0005 5.77605V3.04882C17.0005 1.92001 16.0885 1 14.9685 1" stroke="white" strokeOpacity="0.4" />
                                        <path className="nft-cards__btn-icon-stroke" d="M14.9685 10.1758H12.2644C11.1364 10.1758 10.2324 11.0886 10.2324 12.2246V14.9518C10.2324 16.0798 11.1364 16.9999 12.2644 16.9999H14.9685C16.0885 16.9999 17.0005 16.0798 17.0005 14.9518V12.2246C17.0005 11.0886 16.0885 10.1758 14.9685 10.1758" stroke="white" />
                                    </svg>
                                    <p className="nft-cards__btn-text">{categoryBtnText ? categoryBtnText : 'All'}</p>

                                </div>
                                <div ref={categoryRef} className={`nft-cards__cetegory_popup ${catPopupOpen ? 'nft-cards__cetegory_popup_active' : ''}`}>
                                    ...
                                    <div className='nft-cards__cetegory_popup__selectors'>
                                        <div className='nft-cards__cetegory_popup__selector' onClick={() => {
                                            ...
                                            <svg className='nft-cards__cetegory_popup__selector-icon' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path className='nft-cards__cetegory_popup__selector-icon-fill' d="M4.73605 0H2.03202C0.91201 0 0 0.92001 0 2.04882V4.77605C0 5.91206 0.91201 6.82407 2.03202 6.82407H4.73605C5.86406 6.82407 6.76807 5.91206 6.76807 4.77605V2.04882C6.76807 0.92001 5.86406 0 4.73605 0Z" fill="white" />
                                                <path className='nft-cards__cetegory_popup__selector-icon-fill' d="M4.73605 9.17578H2.03202C0.91201 9.17578 0 10.0886 0 11.2246V13.9518C0 15.0798 0.91201 15.9999 2.03202 15.9999H4.73605C5.86406 15.9999 6.76807 15.0798 6.76807 13.9518V11.2246C6.76807 10.0886 5.86406 9.17578 4.73605 9.17578Z" fill="white" />
                                                <path className='nft-cards__cetegory_popup__selector-icon-fill' d="M13.9685 0H11.2644C10.1364 0 9.23242 0.92001 9.23242 2.04882V4.77605C9.23242 5.91206 10.1364 6.82407 11.2644 6.82407H13.9685C15.0885 6.82407 16.0005 5.91206 16.0005 4.77605V2.04882C16.0005 0.92001 15.0885 0 13.9685 0Z" fill="white" fillOpacity="0.4" />
                                                <path className='nft-cards__cetegory_popup__selector-icon-fill' d="M13.9685 9.17578H11.2644C10.1364 9.17578 9.23242 10.0886 9.23242 11.2246V13.9518C9.23242 15.0798 10.1364 15.9999 11.2644 15.9999H13.9685C15.0885 15.9999 16.0005 15.0798 16.0005 13.9518V11.2246C16.0005 10.0886 15.0885 9.17578 13.9685 9.17578Z" fill="white" />
                                            </svg>
                                            <p className='nft-cards__cetegory_popup__selector-name'>Art</p>
                                            <svg className={`nft-cards__cetegory_popup__selector-tick ${categoriesFilter.art ? 'nft-cards__cetegory_popup__selector-tick_active' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className='nft-cards__cetegory_popup__selector' onClick={() => {
                                            ...
                                            <p className='nft-cards__cetegory_popup__selector-name'>Collectables</p>
                                            <svg className={`nft-cards__cetegory_popup__selector-tick ${categoriesFilter.collectables ? 'nft-cards__cetegory_popup__selector-tick_active' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path className='nft-cards__cetegory_popup__selector-tick-fill' d="M10.978 16.7881C10.8538 16.9241 10.6846 17 10.5087 17C10.3328 17 10.1635 16.9241 10.0394 16.7881L6.29173 12.7034C5.90276 12.2796 5.90276 11.5924 6.29173 11.1693L6.76102 10.6579C7.14999 10.234 7.77991 10.234 8.16888 10.6579L10.5087 13.2076L16.8311 6.3179C17.2201 5.89403 17.8507 5.89403 18.239 6.3179L18.7083 6.82929C19.0972 7.25316 19.0972 7.94033 18.7083 8.36347L10.978 16.7881Z" fill="#6F6FE9" />
                                            </svg>
                                        ...
                                        <div className='nft-cards__cetegory_popup__selector' onClick={() => {
                                            ...
                                            <p className='nft-cards__cetegory_popup__selector-name'>Games</p>
                                            <svg className={`nft-cards__cetegory_popup__selector-tick ${categoriesFilter.games ? 'nft-cards__cetegory_popup__selector-tick_active' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path className='nft-cards__cetegory_popup__selector-tick-fill' d="M10.978 16.7881C10.8538 16.9241 10.6846 17 10.5087 17C10.3328 17 10.1635 16.9241 10.0394 16.7881L6.29173 12.7034C5.90276 12.2796 5.90276 11.5924 6.29173 11.1693L6.76102 10.6579C7.14999 10.234 7.77991 10.234 8.16888 10.6579L10.5087 13.2076L16.8311 6.3179C17.2201 5.89403 17.8507 5.89403 18.239 6.3179L18.7083 6.82929C19.0972 7.25316 19.0972 7.94033 18.7083 8.36347L10.978 16.7881Z" fill="#6F6FE9" />
                                            </svg>
                                        ...
                                        <div className='nft-cards__cetegory_popup__selector' onClick={() => {
                                            ...
                                            <p className='nft-cards__cetegory_popup__selector-name'>Metaverses</p>
                                            <svg className={`nft-cards__cetegory_popup__selector-tick ${categoriesFilter.metaverses ? 'nft-cards__cetegory_popup__selector-tick_active' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path className='nft-cards__cetegory_popup__selector-tick-fill' d="M10.978 16.7881C10.8538 16.9241 10.6846 17 10.5087 17C10.3328 17 10.1635 16.9241 10.0394 16.7881L6.29173 12.7034C5.90276 12.2796 5.90276 11.5924 6.29173 11.1693L6.76102 10.6579C7.14999 10.234 7.77991 10.234 8.16888 10.6579L10.5087 13.2076L16.8311 6.3179C17.2201 5.89403 17.8507 5.89403 18.239 6.3179L18.7083 6.82929C19.0972 7.25316 19.0972 7.94033 18.7083 8.36347L10.978 16.7881Z" fill="#6F6FE9" />
                                            </svg>
                                ...
                                <div ref={priceRef} className={`nft-cards__price_popup ${pricePopupOpen ? 'nft-cards__price_popup_active' : ''}`}>
                                    ...
                                    <div className="nft-cards__price_popup-fiat-selectors">
                                        ...
                                        <div className="nft-cards__price_popup-fiat-selector" onClick={() => {
                                            ...
                                            <div className="nft-cards__price_popup-fiat-icon-container">
                                                <svg className="nft-cards__price_popup-fiat-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path className="nft-cards__price_popup-fiat-icon-fill" d="M11.0228 8.02143C10.6186 7.76158 10.1794 7.56049 9.71859 7.42396C9.45126 7.34136 9.12801 7.25599 8.77791 7.15721C8.48131 7.07462 8.16045 6.99724 7.66088 6.89047L7.66069 6.89065C7.12828 6.7783 6.60556 6.62391 6.09735 6.42934C5.80448 6.31773 5.54442 6.13432 5.34102 5.89605C5.16653 5.66707 5.08022 5.38319 5.09774 5.096V5.01862C5.1134 4.76657 5.2068 4.52533 5.36507 4.32795C5.59884 4.04856 5.90478 3.83838 6.24963 3.72004C6.77402 3.53775 7.32733 3.45181 7.88251 3.46669C8.29618 3.46632 8.70799 3.52194 9.10653 3.63206C9.39474 3.71223 9.66619 3.84319 9.90834 4.0186C10.0717 4.13653 10.2113 4.28385 10.32 4.45331L10.7528 5.12536L12.108 4.26673L11.6751 3.59468H11.6749C11.4579 3.25651 11.1785 2.96244 10.8519 2.72806C10.4611 2.44383 10.0232 2.23087 9.55829 2.09858C9.25554 2.0119 8.94628 1.9494 8.63364 1.91201V0H7.03002V1.90944C6.58615 1.95836 6.14899 2.0549 5.72582 2.19739C5.10073 2.41056 4.54632 2.79058 4.12239 3.29596L4.10095 3.32256V3.32275C3.72326 3.79951 3.50888 4.38471 3.48894 4.99204C3.44699 5.66152 3.64702 6.32391 4.05284 6.85867L4.0795 6.89067C4.45999 7.3544 4.95457 7.71191 5.51475 7.92805C6.10013 8.15276 6.70246 8.33114 7.31595 8.46134C7.77567 8.56272 8.07228 8.6347 8.36364 8.72808C8.70833 8.81347 8.99708 8.89066 9.25102 8.96804H9.25083C9.56532 9.06068 9.86489 9.19703 10.1408 9.37336C10.3218 9.48999 10.475 9.64476 10.5899 9.82668C10.7148 10.0573 10.7774 10.3166 10.7716 10.5787V10.6161C10.7802 10.9346 10.6866 11.2476 10.5043 11.5094C10.2599 11.8393 9.9247 12.0914 9.53957 12.2348C8.98965 12.4511 8.40111 12.5527 7.81034 12.5333H7.75963C7.1135 12.5551 6.47166 12.4206 5.8889 12.1414C5.57664 11.9751 5.30896 11.7365 5.10852 11.4454L4.6516 10.7893L3.33398 11.7013L3.7909 12.3574C4.1425 12.8659 4.6119 13.2822 5.15925 13.5707C5.82815 13.8962 6.5546 14.0875 7.29733 14.1334V16H8.90095L8.90076 14.056C9.32077 13.9918 9.73221 13.8808 10.1276 13.7253C10.7998 13.4708 11.3839 13.027 11.8086 12.4479C12.1949 11.9032 12.3936 11.2483 12.3751 10.5813C12.3956 10.0733 12.2814 9.56881 12.0438 9.11886C11.8063 8.66889 11.4542 8.28942 11.0228 8.01861L11.0228 8.02143Z" fill="white" />
                                                </svg>
                                            </div>
                                            <p className="nft-cards__price_popup-fiat-name">Dollars</p>
                                            <svg className={`nft-cards__cetegory_popup__selector-tick ${selectedFiat === 'dollars' ? 'nft-cards__cetegory_popup__selector-tick_active' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path className='nft-cards__cetegory_popup__selector-tick-fill' d="M10.978 16.7881C10.8538 16.9241 10.6846 17 10.5087 17C10.3328 17 10.1635 16.9241 10.0394 16.7881L6.29173 12.7034C5.90276 12.2796 5.90276 11.5924 6.29173 11.1693L6.76102 10.6579C7.14999 10.234 7.77991 10.234 8.16888 10.6579L10.5087 13.2076L16.8311 6.3179C17.2201 5.89403 17.8507 5.89403 18.239 6.3179L18.7083 6.82929C19.0972 7.25316 19.0972 7.94033 18.7083 8.36347L10.978 16.7881Z" fill="#6F6FE9" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div className="nft-cards__price_popup-fiat-inputs">
                                        <div className="nft-cards__price_popup-fiat-input-container">
                                            <input className='nft-cards__price_popup-fiat-input' placeholder="Min" name="minvalue" type="text" required value={priceMinValue} onChange={handlePriceMinValueChange} minLength="0" maxLength="300"></input>
                                        </div>
                                        <p className="nft-cards__price_popup-fiat-input-separetor">to</p>
                                        <div className="nft-cards__price_popup-fiat-input-container">
                                            <input className='nft-cards__price_popup-fiat-input' placeholder="Max" name="maxvalue" type="text" required value={priceMaxValue} onChange={handlePriceMaxValueChange} minLength="0" maxLength="300"></input>
                                        </div>
                                    </div>
                                    <div className="nft-cards__price_popup-fiat-btns">
                                        <div className="nft-cards__price_popup-fiat-btn nft-cards__price_popup-fiat-btn_reset" onClick={handlePricePopupReset}>
                                            <p className="nft-cards__price_popup-fiat-btn-text">Clear</p>
                                        </div>
                                        <div className="nft-cards__price_popup-fiat-btn nft-cards__price_popup-fiat-btn_apply" onClick={handlePricePopupApply}>
                                            <p className="nft-cards__price_popup-fiat-btn-text nft-cards__price_popup-fiat-btn-text_apply">Apply</p>
                                        </div>
                                    </div>
                    ...
                    {isPreloaderVisible ?
                        <div className="nft-cards__cards-preloader">
                            <Preloader />
                        </div> :
                        <>
