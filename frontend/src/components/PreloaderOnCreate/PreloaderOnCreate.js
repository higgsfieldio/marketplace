...
import './PreloaderOnCreate.css'

const PreloaderOnCreate = () => {
    return (
        <svg className="ap" viewBox="0 0 128 256" width="128px" height="256px" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <linearGradient id="ap-grad1" x1="0" y1="0" x2="0" y2="1">
                    <stop className='ap-grad__stopcolor1' offset="0%" stopColor="#FF0FFF" />
                    <stop className='ap-grad__stopcolor2' offset="100%" stopColor="#FF0FFF" />
                </linearGradient>
                <linearGradient id="ap-grad2" x1="0" y1="0" x2="0" y2="1">
                    <stop className='ap-grad__stopcolor1' offset="0%" stopColor="#FF0FFF" />
                    <stop className='ap-grad__stopcolor2' offset="50%" stopColor="#FF0FFF" />
                    <stop className='ap-grad__stopcolor3' offset="100%" stopColor="#FF0FFF" />
                </linearGradient>
            </defs>
...
export default PreloaderOnCreate
