...
import MiniPreloader from '../MiniPreloader/MiniPreloader';
import './LoginFromRefPopup.css';



function LoginFromRefPopup(props) {
    ...
    return (
        ...
        <div className={`login-popup ${props.loginPopupOpened ? 'login-popup_active' : ''}`}>
            <div className={`login-popup__container ${props.loginPopupOpened ? 'login-popup__container_active' : ''}`}>
                ...
                <p className="login-popup__title">Welcome to Higgs Field!</p>
                <p className="login-popup__subtitle">
                    If you are already a NEAR Resident or want to create your own NEAR Wallet proceed with logging in to start your digital art journey.
                    <br /><br />
                    If you just want to look around, feel free to proceed with that.
                </p>
                ...
                <div className="login-popup__look-btn" onClick={()=>{
                     props.setLoginPopupOpened(false)
                }}>
                    <p className="login-popup__look-btn-text">Look around</p>
...
export default LoginFromRefPopup;
