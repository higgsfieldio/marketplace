...
import './ExploreCollectionsCard.css';


function ExploreCollectionsCard({ card }) {
            ...
            <div className='collection-card__container'>
                <div className='collection-card__heading'>
                    ...
                    <div className='collection-card__about'>
                        ...
                        <p className='collection-card__owner collection-card__owner_pc'>Created by <Link onClick={scrollTop} to={`/profile/${card.creator.user_id}/on-sale`} className='collection-card__owner-name'>{card.creator && card.creator.user_name ? card.creator.user_name : `@${card.creator.user_id}`}</Link></p>
                        <p className='collection-card__owner collection-card__owner_mobile'>by <Link onClick={scrollTop} to={`/profile/${card.creator.user_id}/on-sale`} className='collection-card__owner-name'>{card.creator && card.creator.user_name ? card.creator.user_name : `@${card.creator.user_id}`}</Link></p>
                    </div>
